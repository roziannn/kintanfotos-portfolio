const ServiceItem = ({ icon, title, desc }) => {
  return (
    <div className="bg-white shadow-lg p-6 rounded-lg flex flex-col items-center text-center">
      <div className="w-24 py-8 flex justify-center bg-gray-100 text-lime-500 rounded-md mb-5 md:mb-10">{icon}</div>
...
const Services = () => {
  const services = [
    ...
    { icon: <i className="fa-solid fa-palette text-2xl"></i>, title: "Desain", desc: "Design to cohesive social media feeds, I help build a visual identity that stands out" },
  ];
  return (
